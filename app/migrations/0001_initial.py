    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'HOD'), (2, 'Employee'), (3, 'Instructor'), (4, 'members')], default=1, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.role')),
            ],
        ),
        migrations.CreateModel(
            name='Instructor',
